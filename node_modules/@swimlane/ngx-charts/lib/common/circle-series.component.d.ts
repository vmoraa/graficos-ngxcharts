...
export declare class CircleSeriesComponent implements OnChanges, OnInit {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<CircleSeriesComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<CircleSeriesComponent, "g[ngx-charts-circle-series]", never, { "type": "type"; "tooltipDisabled": "tooltipDisabled"; "data": "data"; "xScale": "xScale"; "yScale": "yScale"; "colors": "colors"; "scaleType": "scaleType"; "visibleValue": "visibleValue"; "activeEntries": "activeEntries"; "tooltipTemplate": "tooltipTemplate"; }, { "select": "select"; "activate": "activate"; "deactivate": "deactivate"; }, never, never>;
}
